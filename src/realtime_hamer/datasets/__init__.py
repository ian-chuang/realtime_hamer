...
def create_dataset(cfg: CfgNode, dataset_cfg: CfgNode, train: bool = True, **kwargs) -> Dataset:
    ...
    """
    # Import training datasets lazily so inference-only installs stay light.
    from .image_dataset import ImageDataset  # noqa: F401
    from .mocap_dataset import MoCapDataset  # noqa: F401
...
def MixedWebDataset(cfg: CfgNode, dataset_cfg: CfgNode, train: bool = True):
    import webdataset as wds

    class _MixedWebDataset(wds.WebDataset):
    ...
    return _MixedWebDataset(cfg, dataset_cfg, train=train)
