...
DEFAULT_CHECKPOINT = f'{CACHE_DIR_HAMER}/hamer_ckpts/checkpoints/new_hamer_weights.ckpt'


def load_hamer(checkpoint_path=DEFAULT_CHECKPOINT, init_renderer: bool = False):
